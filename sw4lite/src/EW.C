...
#pragma omp parallel
    ...
    //set up some timers
    timer t_force("force"), t_checknan("check_nan"), t_evalPred("eval_predictor"), t_evalRHS("evaluate_rhs"), t_commarray("communicate_array"), t_evalDpDmInTime("evalDpDmInTime");
    timer t_cartforce("cartesian_bc_forcing"), t_evalCorr("eval_corrector");
    ...
    //print all counters:
    t_force.print(); t_checknan.print(); t_evalPred.print();  t_evalRHS.print(); t_commarray.print(); t_evalDpDmInTime.print();
    t_cartforce.print(); t_evalCorr.print();
    
    //print solver execution time
